...
namespace Andreea_Zoicas_Lab2.Data
{
    public class Andreea_Zoicas_Lab2Context : DbContext
    {
        ...
        public DbSet<Andreea_Zoicas_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Andreea_Zoicas_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Andreea_Zoicas_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
